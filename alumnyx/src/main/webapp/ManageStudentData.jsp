...
<title>alumnyx | Manage Student</title>
...
<div class="container">
	...
	<table id="background" class="table table text-white">
		<thead>
			<tr>
				<th scope="col">PRN</th>
		...
		<tbody>
			<%
			ArrayList<StudentData> list1 = (ArrayList<StudentData>) request.getAttribute("liststudent");
			for (StudentData s : list1) {
			%>
			<tr>
				<td>
					<%
				...
				<td><a
					href="UpdateStudent.jsp?email=<%out.print(s.getEmail());%>"
					class="btn btn-success">Edit</a></td>
				<td><a href="deletestudent?email=<%out.print(s.getEmail());%>"
