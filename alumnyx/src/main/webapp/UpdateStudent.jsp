...
<title>alumnyx | Update Student</title>
...
<c:if test="${empty userObj}">
	...
	StudentData data = new StudentData(email);
	StudentData md = dao.getStudentbyEmail(data);
	%>
	
	<div class="container">
		<h1 class="h3 mb-3 fw-normal">
			<a href="ShowStudentData" style="text-decoration: none; color: black;">alumnyx</a>
		</h1>
				...
				<div class="user-details">
					<div class="input-box">
						<span class="details">Full Name</span> <input type="text"
							placeholder="Enter Name" name="name" id="fullname"
							value="<%=md.getName()%>" required />
					</div>
					<div class="input-box">
						<span class="details">Username</span> <input type="text"
							placeholder="Enter Username" name="uName" id="usernames"
					...
					<div class="input-box">
						...
						<%-- <input type="number" placeholder="Enter Graduation Year" name="graduationYear" value="<%=md.getGraduationYear()%>" required /> --%>
						<select id="ddlYears" name="graduationYear"
							value="<%=md.getGraduationYear()%>" required><option selected><%=md.getGraduationYear()%></option></select>
					</div>
					<div class="input-box">
					...
					<div class="input-box">
						<span class="details">PRN No</span> <input type="number"
							placeholder="Enter PRN No" name="prn_no"
							value="<%=md.getPrn_no()%>" id="prn" required />
					</div>
					<div>
