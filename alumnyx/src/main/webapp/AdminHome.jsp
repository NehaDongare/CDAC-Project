...
<body>
	...
	<!-- <nav class="navbar navbar-expand-lg navbar-dark bg-light">
		<div class="container-fluid">
			<a class="navbar-brand" href="AdminHome.html"><img width="130px"
			...
			<div class="collapse navbar-collapse" id="navbarText">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="AdminHome.html">Home</a></li>
					<li class="nav-item"><a class="nav-link"
						href="ManageUsers.jsp">Manage Alumni Data</a></li>
					<li class="nav-item"><a class="nav-link"
						href="ManageStudentData.jsp">Manage Student Data</a></li>
					<li class="nav-item"><a class="nav-link"
						href="ManageEvents.jsp">Manage Events</a></li>
				</ul>
	...
	<div class="container marketing">
		...
		<div class="row">
			<div class="col-lg-4">
				...
				<img width="140" height="140"
					src="https://source.unsplash.com/140x140/?principal"
			...
			<div class="col-lg-4">
				<!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140"
                        ...
                        preserveAspectRatio="xMidYMid slice" focusable="false"> -->
				<img width="140" height="140"
					src="https://source.unsplash.com/140x140/?notice"
					class="bd-placeholder-img rounded-circle" alt="..." />
				<title>Placeholder</title>
				<!-- <rect width="100%" height="100%" fill="#777" /><text x="50%" y="50%" fill="#777"
                            dy=".3em">140x140</text> -->
				...
				<p>Start of PG-Diploma Courses across India: September 21, 2021</p>
				<p>
			...
			<div class="col-lg-4">
				...
				<p>
					<a class="btn btn-primary" href="#">Download &raquo;</a>
				</p>
			</div>
			<!-- /.col-lg-4 -->
		</div>
		...
		<div class="row featurette">
			<div class="col-md-7">
				...
				<p class="lead">"Happiness is not something ready made. It comes
					from your own actions." - Dalai Lama XIV</p>
			</div>
			<div class="col-md-5">
				<!-- <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                        height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500"
