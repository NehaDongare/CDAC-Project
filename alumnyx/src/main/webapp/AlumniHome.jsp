	...
	<header>
		<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
			<div class="container-fluid">
				<a class="navbar-brand" href="AlumniHome.jsp"><img width="130px"
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="AlumniHome.jsp">Home</a></li>
						<li class="nav-item"><a class="nav-link"
							href="AlumniProfile.jsp">Profile</a></li>
						<li class="nav-item"><a class="nav-link"
							href="ShowUserEvents">Upcoming Events</a></li>
					</ul>
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<!-- <svg class="bd-placeholder-img rounded-circle" width="140" height="140"
                        ...
                        preserveAspectRatio="xMidYMid slice" focusable="false"> -->
				<img width="140" height="140"
					src="https://source.unsplash.com/140x140/?admission"
					class="bd-placeholder-img rounded-circle" alt="..." />
				<title>Placeholder</title>
				<!--  <rect width="100%" height="100%" fill="#777" /><text x="50%" y="50%" fill="#777"
                            dy=".3em">140x140</text>
			...
			<!--  <div class="col-lg-4">
                    <svg class="bd-placeholder-img rounded-circle" width="140" height="140"
                        xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140"
                        preserveAspectRatio="xMidYMid slice" focusable="false">
                        <img width="140" height="140" src="https://source.unsplash.com/140x140/?magazine"
                        class="bd-placeholder-img rounded-circle" alt="..." />
                        <title>Placeholder</title>
                        <rect width="100%" height="100%" fill="#777" /><text x="50%" y="50%" fill="#777"
                            dy=".3em">140x140</text>
			...
			<div class="row featurette">
				...
				<div class="col-md-5 order-md-1">
					<!-- <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                        ...
                        preserveAspectRatio="xMidYMid slice" focusable="false"> -->
					<img width="500" height="500"
						src="https://source.unsplash.com/500x500/?graduate, alumni, institude"
						class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
						alt="..." />
					<title>Placeholder</title>
					<!-- <rect width="100%" height="100%" fill="#eee" /><text x="50%" y="50%" fill="#aaa"
			...
			<div class="row featurette">
				...
				<div class="col-md-5">
					<!-- <svg class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                        ...
                        preserveAspectRatio="xMidYMid slice" focusable="false"> -->
					<img width="500" height="500"
						src="https://source.unsplash.com/500x500/?graduate, alumni"
						class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
						alt="..." />
					<title>Placeholder</title>
					<!--  <rect width="100%" height="100%" fill="#eee" /><text x="50%" y="50%" fill="#aaa"
